  ...
  element.innerHTML = `
    ...
    product.name
     ...
     <ul class="product-thumbnails-carousel">
        <li>
            <img class="product-thumbnail" src="../../src/assets/images/products/product-secondary-thumbnail-1.png" alt="${
              product.name
            }" />
        </li>
        <li>
            <img class="product-thumbnail" src="../../src/assets/images/products/product-secondary-thumbnail-2.png" alt="${
              product.name
            }" />
        </li>
        <li>
            <img class="product-thumbnail" src="../../src/assets/images/products/product-secondary-thumbnail-3.png" alt="${
              product.name
            }" />
        </li>
        <li>
            <img class="product-thumbnail" src="../../src/assets/images/products/product-secondary-thumbnail-4.png" alt="${
              product.name
            }" />
        </li>
    ...
    product.category
            ...
            <div class="payment-options">
              ...
              <img src="../../src/assets/images/product-page/visa-pay-logo.png" alt="Visa"/>
              <img src="../../src/assets/images/product-page/american-express-logo.png" alt="american express"/>
              <img src="../../src/assets/images/product-page/master-card-logo.png" alt="master card"/>
              <img src="../../src/assets/images/product-page/paypal-logo.png" alt="paypal"/>
            </div>
          </div>
